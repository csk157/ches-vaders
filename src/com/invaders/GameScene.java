...
import com.invaders.model.Bullet;
import com.invaders.model.BulletPool;
import com.invaders.model.CoolDown;
import com.invaders.model.Enemy;
import com.invaders.model.EnemyLayer;
import com.invaders.model.EnemyPool;
import com.invaders.model.Ship;
...
public class GameScene extends Scene implements IOnSceneTouchListener {
	...
	public GameScene() {
		...
		SpriteBackground bg = new SpriteBackground(new Sprite(0, 0, BaseActivity.getSharedInstance().mBg, BaseActivity.getSharedInstance().getVertexBufferObjectManager()));
		setBackground(bg);
//		setBackground(new Background(0.09804f, 0.2274f, 0.3784f));
		// attaching an EnemyLayer entity with 12 enemies on it 27 27 
		attachChild(new EnemyLayer(27));
	...
	private void createExplosion(final float posX, final float posY, final IEntity target, final SimpleBaseGameActivity activity) {
		...
		IEntityFactory recFact = new IEntityFactory() {
		    ...
		    public Rectangle create(float pX, float pY) {
		        Rectangle rect = new Rectangle(posX, posY, 3, 3, activity.getVertexBufferObjectManager());
